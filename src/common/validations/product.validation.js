...
const createProductSchema = joi.object({
    ...
    colors: joi.string().error(httpError.BadRequest("رنگ انتخابی صحیح نمیباشد")),
    category: joi.string().pattern(MongoIDPattern).error(httpError.BadRequest("رنگ انتخابی صحیح نمیباشد")),
